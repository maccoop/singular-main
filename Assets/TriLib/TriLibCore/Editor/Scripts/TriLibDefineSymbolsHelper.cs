...
namespace TriLibCore.Editor
{
    public static class TriLibDefineSymbolsHelper
    {
        public static bool IsSymbolDefined(string targetDefineSymbol)
        {
            ...
            var defineSymbols = PlayerSettings.GetScriptingDefineSymbols(NamedBuildTarget.Unknown);
#else
...
#if UNITY_2020_3_OR_NEWER
            PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.Unknown, newDefineSymbols);
#else
